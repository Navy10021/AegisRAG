...
from src.models import AnalysisResult, ScoreBreakdown, ExplanationData
...
class TestExplainableAI:
    ...
    def score_breakdown(self):
        ...
        breakdown.keyword_matches = {"password": 30.0, "leak": 25.0, "detected": 10.0}
        breakdown.policy_similarities = {"P001": 28.5, "P002": 17.4}
    ...
    def test_generate_explanation_basic(self, sample_result, score_breakdown):
        ...
        explanation = ExplainableAI.generate_explanation(
            sample_result, score_breakdown, similar_cases=None
        )
    ...
    def test_similar_cases_integration(self, sample_result, score_breakdown):
        ...
        explanation = ExplainableAI.generate_explanation(
            sample_result, score_breakdown, similar_cases=similar_cases
        )
    ...
    def test_empty_breakdown(self, sample_result):
        ...
        explanation = ExplainableAI.generate_explanation(sample_result, empty_breakdown)
    ...
    def test_high_score_keywords_only(self, sample_result):
        ...
        breakdown = ScoreBreakdown()
        breakdown.keyword_matches = {"critical": 40.0, "breach": 35.0}
        breakdown.final_score = 75.0

        explanation = ExplainableAI.generate_explanation(sample_result, breakdown)
    ...
    def test_policy_similarity_in_factors(self, sample_result):
        ...
        policy_factors = [
            f for f, _, _, _ in explanation.key_factors if f.startswith("P")
        ]
